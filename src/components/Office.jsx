...
const Office = () => {
  return (
    <>
      ...
      >
        We&apos;re ready to lead you into the future of B-BBEE. You&apos;re not
        going to hit a ridiculously long phone menu when you call us. Your email
        isn&apos;t going to the inbox abyss, never to be seen or heard from
        again. At mPowerRatings, we provide the exceptional service we&apos;d
        want to experience ourselves!
        <br />
        <br />
        We operate in an industry built on trust, from the first contact past
        your tenth verification with us.{" "}
      ...
      <motion.div
        ...
        className="mt-10 mb-6 grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5"
      >
        ...
        <ContactItem icon={IconUser} className="md:col-span-2">
          <div className="flex flex-col gap-1">
            ...
            <span>
              Lizelle de Jager · Magret Mothibi · Jeanet Mahlalela · Jaques
              Koekemoer
            </span>
            <span className="text-[14px] text-primary/80">
              Verification Managers / SANAS Technical Signatories: Jeanet
              Mahlalela &amp; Magret Mothibi · Jaques Koekemoer (SANAS Approved
              Technical Signatory) · Head of Sales &amp; Marketing (TBA)
            </span>
