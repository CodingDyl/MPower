    ...
    >
      ...
      >
        <Text size="sm" mb={18} style={{ color: "rgba(213,221,240,0.88)", lineHeight: 1.6 }}>
          Tell us who you are and what you need. We&apos;ll scope your verification
          and get a human back to you.
        </Text>
        ...
        <form ref={formRef} onSubmit={handleSubmit}>
          <Stack gap="md">
            ...
            <div>
              <label className="mb-1.5 block text-[14px] font-semibold text-[#e8eefc]/90">
                Quote type
              </label>
              <select
                required
                ...
                className="w-full rounded-full border border-white/20 bg-white/[0.06] px-4 py-2.5 text-[14px] text-[#f4f7ff] outline-none transition focus:border-[#C8952F]/70"
              >
                <option value="" disabled className="bg-[#1a2d52] text-white">
                  Select quote type
                </option>
                {quoteTypeOptions.map((option, index) => (
                  <option
                    key={index}
                    value={option}
                    className="bg-[#1a2d52] text-white"
                  >
                    {option}
                  </option>
                ))}
              ...
              >
                ...
                <div>
                  <Text size="sm" ta="center" style={{ color: "#e8eefc" }}>
                    Drop your Company Information Form here, or click to upload
                  </Text>
                  <Text size="xs" ta="center" mt={6} style={{ color: "rgba(213,221,240,0.55)" }}>
                    Excel (.xls / .xlsx), up to 10MB
                  </Text>
                </div>
              </Group>
            </Dropzone>
