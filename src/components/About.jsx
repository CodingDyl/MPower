...
const About = () => {
  const ServiceCard = ({ index, title }) => (
    ...
    >
      <motion.div
        ...
        className="w-full brand-gradient p-[1px] rounded-3xl shadow-card hover:shadow-card-hover transition-shadow duration-300 cursor-pointer"
      >
        <div className="bg-white rounded-3xl py-5 px-4 sm:py-7 sm:px-8 min-h-[150px] sm:min-h-[200px] flex flex-col justify-center items-center gap-3 sm:gap-5">
  ...
  return (
    <>
      ...
      >
        mPowerRatings is a SANAS Accredited B-BBEE Verification Agency (BVA
        204). Established in 2004, we have been at the forefront of
        transformation for over two decades. Our tagline (
        <span className="font-semibold text-tertiary">
          Ensuring change through empowerment
        </span>
        ) guides how we work: expert B-BBEE knowledge that drives sustainable,
        inclusive growth across South Africa. We guide clients through the
        transformation landscape with credibility and care.{" "}
        <span className="font-semibold text-tertiary">
          mPowerRatings is a 51% Black Female Owned, Level 2 B-BBEE Contributor.
        </span>{" "}
        Ownership: Lizelle de Jager, Magret Mothibi, Jeanet Mahlalela, and
        Jaques Koekemoer. To find out more, contact us at{" "}
        <a
          href="tel:0118800060"
