...
const Home = () => {
  ...
  return (
    <section className="relative w-full h-screen mx-auto backdrop-blur-md">
      <div className={`${styles.paddingX} absolute inset-0 xs:top-[200px] md:top-[250px] max-w-7xl md:flex sm:flex-col md:flex-row justify-center xs:items-center md:items-start mx-auto gap-5`}>
        <div>
