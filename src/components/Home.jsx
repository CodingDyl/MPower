...
const Home = () => {
  ...
  return (
    <section className="relative w-full h-screen mx-auto backdrop-blur-md">
      <div className={`${styles.paddingX} absolute inset-0 top-[200px] max-w-7xl md:flex sm:flex-col sm:align-middle md:flex-row justify-center sm:items-center md:items-start mx-auto gap-5`}>
        <div>
